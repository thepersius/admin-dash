            ...
            <CForm>
              <div className="mb-3">
                ...
                <CFormInput
                  ...
                  placeholder="Contoh: Berita Terupdate Hari Ini"
                />
              </div>
              <div className="mb-3">
                <CFormLabel htmlFor="exampleFormControlInput1">Diterbitkan Oleh</CFormLabel>
                <CFormInput
                  type="email"
                  id="exampleFormControlInput1"
                  placeholder="Nama contoh: Adinda"
                />
              </div>
              <div>
              <CFormLabel htmlFor="exampleFormControlInput1">Foto Berita</CFormLabel>
                <CInputGroup className="mb-3">
                  <CInputGroupText component="label" htmlFor="inputGroupFile01">
                    Upload</CInputGroupText>
                    <CFormInput type="file" id="inputGroupFile01"/>
                    </CInputGroup></div>
              <div className="mb-4">
                <CFormLabel>Tanggal</CFormLabel>
                {/* https://reactdatepicker.com/#example-default */}
                <Datetime />
              </div>
              <div className="mb-3">
                <CFormLabel htmlFor="exampleFormControlTextarea1">Isi Konten</CFormLabel>
